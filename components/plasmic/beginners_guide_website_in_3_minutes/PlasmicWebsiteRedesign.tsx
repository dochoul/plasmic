...
import sty from "./PlasmicWebsiteRedesign.module.css"; // plasmic-import: ANEjvjOYnAKU/css
    ...
    <React.Fragment>
      ...
      <div className={projectcss.plasmic_page_wrapper}>
        ...
        >
          ...
          <section
            className={classNames(projectcss.all, sty.section__fgGcO)}
            id={"Services"}
          >
            <PlasmicImg__
              alt={""}
              className={classNames(sty.img__jqLc)}
              displayHeight={"700px"}
          ...
          <section
            className={classNames(projectcss.all, sty.section__jO27)}
            id={"work"}
          >
            <div className={classNames(projectcss.all, sty.freeBox__w5D2N)}>
              <h3
                className={classNames(
                  projectcss.all,
                  projectcss.h3,
            ...
            <div className={classNames(projectcss.all, sty.freeBox__zgRdw)}>
              <h3
                className={classNames(
                  projectcss.all,
                  projectcss.h3,
            ...
            <div className={classNames(projectcss.all, sty.freeBox__quLLc)}>
              <h3
                className={classNames(
                  projectcss.all,
                  projectcss.h3,
            ...
            <section
              className={classNames(projectcss.all, sty.section___14DXc)}
              id={"about"}
            >
              <div className={classNames(projectcss.all, sty.freeBox__i9QFs)}>
                <PlasmicImg__
                  alt={""}
                  className={classNames(sty.img__nrtrP)}
                  displayHeight={"auto"}
                  displayMaxHeight={"none"}
                  displayMaxWidth={"100%"}
                  displayMinHeight={"0"}
                ...
                <div
                  className={classNames(projectcss.all, sty.columns___64VU3)}
                >
                  <div
                    className={classNames(projectcss.all, sty.column__eEk4L)}
                  >
                    <PlasmicImg__
                      alt={""}
                      className={classNames(sty.img__zZUt2)}
                      displayHeight={
                  ...
                  <div
                    className={classNames(projectcss.all, sty.column___2EvYm)}
                  >
                    <PlasmicImg__
                      alt={""}
                      className={classNames(sty.img__zwWPl)}
                      displayHeight={
                        hasVariant(globalVariants, "screen", "mobileOnly")
                          ? "300px"
                          : "600px"
              ...
              <div className={classNames(projectcss.all, sty.freeBox___0YUa2)}>
                <h3
                  className={classNames(
                    projectcss.all,
                    projectcss.h3,
            ...
            <section
              className={classNames(projectcss.all, sty.section__mwWeX)}
              id={"about"}
            >
              <div className={classNames(projectcss.all, sty.freeBox___3CtNf)}>
                <PlasmicImg__
                  alt={""}
                  className={classNames(sty.img__mkT9Z)}
                  displayHeight={"auto"}
                  displayMaxHeight={"none"}
                  displayMaxWidth={"100%"}
                  displayMinHeight={"0"}
              ...
              <div className={classNames(projectcss.all, sty.freeBox__bN7Sn)}>
                <h3
                  className={classNames(
                    projectcss.all,
                    projectcss.h3,
            ...
            <section
              className={classNames(projectcss.all, sty.section__za8AY)}
              id={"contact"}
            >
              <div className={classNames(projectcss.all, sty.freeBox__evfQe)}>
                <h2
              ...
              <div className={classNames(projectcss.all, sty.columns__dWq6V)}>
                <div className={classNames(projectcss.all, sty.column___8W7Nh)}>
                  <ProjectCard
                    className={classNames(
                      "__wab_instance",
                      sty.projectCard__mwJVa
                    )}
                    image={{
                ...
                <div className={classNames(projectcss.all, sty.column__snMv)}>
                  <ProjectCard
                    className={classNames(
                      "__wab_instance",
                      sty.projectCard__gSbYa
                    )}
