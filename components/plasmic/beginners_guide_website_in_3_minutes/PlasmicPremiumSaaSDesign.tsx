...
import sty from "./PlasmicPremiumSaaSDesign.module.css"; // plasmic-import: TX3IeZtOXtTN/css
    ...
    <React.Fragment>
      ...
      <div className={projectcss.plasmic_page_wrapper}>
        ...
        >
          ...
          <section
            className={classNames(projectcss.all, sty.section__bCkT0)}
            id={"Services"}
          >
            <PlasmicImg__
              alt={""}
              className={classNames(sty.img__jV8A)}
              displayHeight={"700px"}
          ...
          <section
            className={classNames(projectcss.all, sty.section__fZ9V6)}
            id={"work"}
          >
            <div className={classNames(projectcss.all, sty.freeBox___3V3Ds)}>
              <h3
                className={classNames(
                  projectcss.all,
                  projectcss.h3,
            ...
            <div className={classNames(projectcss.all, sty.freeBox__he3T)}>
              <h3
                className={classNames(
                  projectcss.all,
                  projectcss.h3,
            ...
            <div className={classNames(projectcss.all, sty.freeBox__terXr)}>
              <h3
                className={classNames(
                  projectcss.all,
                  projectcss.h3,
            ...
            <section
              className={classNames(projectcss.all, sty.section___26Iie)}
              id={"about"}
            >
              <div className={classNames(projectcss.all, sty.freeBox___22JSd)}>
                <PlasmicImg__
                  alt={""}
                  className={classNames(sty.img__plGd)}
                  displayHeight={"auto"}
                  displayMaxHeight={"none"}
                  displayMaxWidth={"100%"}
                  displayMinHeight={"0"}
                ...
                <div className={classNames(projectcss.all, sty.columns__czneA)}>
                  <div className={classNames(projectcss.all, sty.column__rBlM)}>
                    <PlasmicImg__
                      alt={""}
                      className={classNames(sty.img__unfLb)}
                      displayHeight={
                  ...
                  <div
                    className={classNames(projectcss.all, sty.column__u4R4E)}
                  >
                    <PlasmicImg__
                      alt={""}
                      className={classNames(sty.img___6JqD6)}
                      displayHeight={
                        hasVariant(globalVariants, "screen", "mobileOnly")
                          ? "300px"
                          : "600px"
              ...
              <div className={classNames(projectcss.all, sty.freeBox__tsNtB)}>
                <h3
                  className={classNames(
                    projectcss.all,
                    projectcss.h3,
            ...
            <section
              className={classNames(projectcss.all, sty.section__gTMnw)}
              id={"about"}
            >
              <div className={classNames(projectcss.all, sty.freeBox__dWvmf)}>
                <PlasmicImg__
                  alt={""}
                  className={classNames(sty.img__lfmDo)}
                  displayHeight={"auto"}
                  displayMaxHeight={"none"}
                  displayMaxWidth={"100%"}
                  displayMinHeight={"0"}
              ...
              <div className={classNames(projectcss.all, sty.freeBox__qlc9A)}>
                <h3
                  className={classNames(
                    projectcss.all,
                    projectcss.h3,
            ...
            <section
              className={classNames(projectcss.all, sty.section__sUdel)}
              id={"contact"}
            >
              <div className={classNames(projectcss.all, sty.freeBox___2Vpv3)}>
                <h2
              ...
              <div className={classNames(projectcss.all, sty.columns__sDzuN)}>
                <div className={classNames(projectcss.all, sty.column__nGs6S)}>
                  <ProjectCard
                    className={classNames(
                      "__wab_instance",
                      sty.projectCard__aKzp7
                    )}
                    image={{
                ...
                <div className={classNames(projectcss.all, sty.column__tqQx)}>
                  <ProjectCard
                    className={classNames(
                      "__wab_instance",
                      sty.projectCard___8BQeU
                    )}
