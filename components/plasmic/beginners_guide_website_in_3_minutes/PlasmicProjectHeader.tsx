...
import sty from "./PlasmicProjectHeader.module.css"; // plasmic-import: vYekxEqyDLgZ/css
...
function PlasmicProjectHeader__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div className={classNames(projectcss.all, sty.columns__u14FI)}>
        <div className={classNames(projectcss.all, sty.column__tzxD4)}>
          <div
            className={classNames(
              projectcss.all,
        ...
        <div className={classNames(projectcss.all, sty.column__m689I)}>
          <div className={classNames(projectcss.all, sty.columns__eJxQg)}>
            <div className={classNames(projectcss.all, sty.column__wf2Ip)}>
              <div
                className={classNames(
                  projectcss.all,
                  projectcss.__wab_text,
              ...
              <div className={classNames(projectcss.all, sty.freeBox__zwLCo)}>
                {renderPlasmicSlot({
            ...
            <div className={classNames(projectcss.all, sty.column___6D9B3)}>
              <div
                className={classNames(
                  projectcss.all,
                  projectcss.__wab_text,
              ...
              <div className={classNames(projectcss.all, sty.freeBox__utg1B)}>
                {renderPlasmicSlot({
